...
const FinanceReview = ({ user }) => {
    ...
    const isPrevApproved = (contract) => {
        ...
        return contract?.reviews?.Legal?.status === 'Approved';
    };
    ...
    const handleAction = async (id, action) => {
        ...
        try {
            ...
            if (status === 'Approved') {
                setToast('✅ Approved! Moved to Compliance Review');
                setTimeout(() => setToast(null), 3000);
            }
    ...
    const openReview = (contract) => {
        ...
        const deptClauses = contractClauses.filter(c => c.department === 'Finance');
