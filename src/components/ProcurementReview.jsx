...
const ProcurementReview = ({ user }) => {
    ...
    const isPrevApproved = (contract) => {
        ...
        return contract?.reviews?.Compliance?.status === 'Approved';
    };
    ...
    const handleAction = async (id, action) => {
        ...
        try {
            ...
            if (status === 'Approved') {
                setToast('✅ Approved! CAS Generated');
                setTimeout(() => setToast(null), 3000);
            }
    ...
    const openReview = (contract) => {
        ...
        const deptClauses = contractClauses.filter(c => c.department === 'Procurement');
